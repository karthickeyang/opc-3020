<?php
class ControllerExtensionModuleMessenger extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('extension/module/messenger');
		...
		$this->response->setOutput($this->load->view('extension/module/messenger', $data));

	}

	protected function validate() {

		if (!$this->user->hasPermission('modify', 'extension/module/messenger')) {
